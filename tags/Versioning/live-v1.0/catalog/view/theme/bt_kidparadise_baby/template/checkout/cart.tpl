...
<?php } ?>
  ...
  <div class="content">
    <p style="margin-bottom:9px;"><span style="color:#f1248e;">(If you want to avail discount coupon or voucher you have to register/login first)</span><br><br><?php echo $text_next_choice; ?></p>
    <table class="radio">
